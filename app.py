...
reader2=reader1.drop(['_id'],axis=1)
#print("Reader 3 ",reader2)

reader4=reader1.drop(['_id'],axis=1)

book_cf=reader1.drop(['_id'],axis=1)

book_cf_1=reader1.drop(['_id'],axis=1)

# client = MongoClient("mongodb://localhost:27017/")
client = MongoClient("mongodb+srv://21x029:RithikkaRs@cluster0.cvahjrg.mongodb.net/")
...
ratings=ratings.drop(['_id', 'rating'],axis=1)
print(ratings)
